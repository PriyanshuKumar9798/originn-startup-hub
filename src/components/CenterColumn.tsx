    ...
    <div className="bg-card border border-border flex overflow-x-auto">
      {tabs.map((tab) => (
        <button
          ...
          className={`px-5 py-2.5 text-xs font-semibold uppercase tracking-wider border-r border-border last:border-r-0 rounded-none transition-colors whitespace-nowrap ${
            activeTab === tab
